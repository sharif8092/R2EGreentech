...
import { LayoutDashboard, Users, FileText, LogOut, Settings, ExternalLink, Image as ImageIcon, MonitorPlay } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 bg-slate-900 text-white flex-shrink-0 flex flex-col h-screen sticky top-0">
        ...
        <div className="px-4 pt-6 pb-2">
            <Link 
              to="/" 
              className="flex items-center justify-center w-full bg-emerald-600 hover:bg-emerald-500 text-white p-3 rounded-xl transition-all shadow-lg shadow-emerald-900/20 group border border-emerald-500"
            >
                <span className="text-xs font-black uppercase tracking-widest mr-2">Exit to Website</span>
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-950/30">
           ...
           <button 
             ...
             className="w-full flex items-center justify-center space-x-2 bg-red-500/10 text-red-400 hover:bg-red-500 hover:text-white px-4 py-3 rounded-xl transition-all text-xs font-bold uppercase tracking-widest border border-transparent hover:border-red-400"
           >
