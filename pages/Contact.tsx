...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Save to localStorage (Simulating Backend Database)
    const existingLeads = JSON.parse(localStorage.getItem('r2e_leads') || '[]');
    const newLead = {
      id: Date.now(),
      ...formData,
      date: new Date().toISOString()
    };
    localStorage.setItem('r2e_leads', JSON.stringify([...existingLeads, newLead]));
            ...
            <div className="lg:col-span-7 order-1 lg:order-2">
              <div className="bg-white p-6 md:p-12 rounded-[2rem] md:rounded-[2.5rem] shadow-2xl border border-slate-100 relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                  ...
                  <button type="submit" className="w-full py-4 bg-emerald-700 text-white rounded-lg font-black text-sm uppercase tracking-widest hover:bg-emerald-800 transition-all shadow-xl shadow-emerald-900/10">
