...
const Services: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const [srvRes, settingsRes] = await Promise.allSettled([
          axios.get("https://r2egreentech.in/backend/services/get-services.php"),
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <div className="flex flex-col items-center">
          ...
          <div className="text-emerald-600 font-bold text-sm tracking-widest uppercase">Loading Services...</div>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-24 md:space-y-32">
            {services.map((service: any, idx) => {
              const srvId = service.id || service.slug;
              
              // Dynamic Image & Position mapping from Site Settings
              ...
              return (
                <div key={srvId || idx} id={srvId} className={`grid lg:grid-cols-12 gap-12 md:gap-16 items-start scroll-mt-24 md:scroll-mt-32 ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
                  ...
                  <div className={`lg:col-span-5 ${idx % 2 !== 0 ? 'lg:order-last' : ''} order-first lg:order-none`}>
                    <div className="relative">
                      ...
                      <img 
                        ...
                        style={{ objectPosition: dynamicPos }}
                        alt={service.title} 
                      />
                      
                      {/* Floating Indicator for HVAC */}
                      {(srvId === 'hvac' || srvId === 'quality') && (
                      ...
                      {/* Floating Indicator for E-Waste/Solar */}
                      {(srvId === 'ewaste' || srvId === 'solar') && (
                        ...
                        <div className="relative z-10 flex items-center justify-between">
                          <div>
                            ...
                            <h4 className="text-base md:text-lg font-black tracking-tight uppercase pr-4">
                              {srvId === 'quality' ? 'Team with Certified Black Belt' : 'Industrial Scale-up Ready'}
                            </h4>
                          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 bg-emerald-600 rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-20 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link to="/contact" className="px-8 md:px-12 py-4 md:py-5 bg-white text-emerald-900 rounded-2xl font-black text-base md:text-lg shadow-xl hover:bg-slate-50 transition-all flex items-center justify-center">
